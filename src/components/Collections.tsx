      ...
      <div className={`h-[400px] sm:h-[100vh]  dark:bg-black bg-white flex-col flex justify-around `}>
        ...
        <Slide damping={0.1} direction="up" duration={1200} triggerOnce >
            <div className=" sm:h-[72vh] h-[30vh]  flex justify-evenly sm:justify-center sm:gap-7">
                    ...
                    <div className=" h-full w-[110px]  sm:w-[25%] rounded-xl sm:rounded-3xl  bg-cover sm:bg-center bg-no-repeat  bg-[url('/images/c1.png')]">
                    ...
                    <div className="h-full  w-[120px] sm:w-[27%] bg-cover sm:bg-center rounded-xl sm:rounded-3xl  bg-[url('/images/c2.png')]">
                      <div className=" h-[95%] flex-col flex justify-end items-center">
                    ...
                    <div className="sm:h-full  w-[110px] sm:w-[25%] bg-cover sm:bg-center rounded-xl sm:rounded-3xl  bg-[url('/images/c3.png')]">
                      <div className=" h-[95%] flex-col flex justify-end items-center">
